                            ...
                            <?php $__currentLoopData = $support->conversations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $conversations): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="chat-item chat-<?php echo e(!empty($conversations->sender_id) ? 'right' : 'left'); ?>">
                                    ...
                                    <div class="chat-details">
                                        ...
                                        <div class="chat-text"><?php echo e(nl2br($conversations->message)); ?></div>
                                        <div class="chat-time">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/examsexplorer/public_html/resources/views/admin/supports/conversation.blade.php ENDPATH**/ ?>