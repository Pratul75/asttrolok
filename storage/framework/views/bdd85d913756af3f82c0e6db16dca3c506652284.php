                ...
                <div class="modal-video-lists mt-15">
                    ...
                    <form method="Post" action="/login" class="mt-35">
                        <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
                         <input type="hidden" name="rd" value="<?php echo e(url()->current()); ?>">
...
<?php /**PATH /home/examsexplorer/public_html/resources/views/web/default/course/login_modal.blade.php ENDPATH**/ ?>