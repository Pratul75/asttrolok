                    ...
                    <div class="row mt-5 cart-row">
                        ...
                        <div class="col-6 col-lg-2 d-flex flex-md-column align-items-center justify-content-center">
                            ...
                            <?php if(!empty($cartItemInfo['discountPrice'])): ?>
                                <span class="text-gray text-decoration-line-through mx-10 mx-md-0"><?php echo e(handlePrice($cartItemInfo['price'], true, true, false, null, true)); ?></span>
                                <span class="font-20 text-primary mt-0 mt-md-5 font-weight-bold"><?php echo e(handlePrice($cartItemInfo['discountPrice'], true, true, false, null, true)); ?></span>
                            <?php else: ?>
                                <span class="font-20 text-primary mt-0 mt-md-5 font-weight-bold"><?php echo e(handlePrice($cartItemInfo['price'], true, true, false, null, true)); ?></span>
                            <?php endif; ?>
...
<?php echo $__env->make(getTemplate().'.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/examsexplorer/public_html/resources/views/web/default/cart/cart.blade.php ENDPATH**/ ?>