                                ...
                                <?php if(!empty($selectSupport->conversations) and !$selectSupport->conversations->isEmpty()): ?>
                                    ...
                                    <?php $__currentLoopData = $selectSupport->conversations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $conversations): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="rounded-sm mt-15 panel-shadow border p-15">
                                            ...
                                            <p class="text-gray font-14 mt-15 font-weight-500"><?php echo e(nl2br($conversations->message)); ?></p>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make(getTemplate() .'.panel.layouts.panel_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/examsexplorer/public_html/resources/views/web/default/panel/support/conversations.blade.php ENDPATH**/ ?>