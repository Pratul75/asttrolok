        ...
        <div class="section-body">
            ...
            <div class="row">
                <div class="col-12 col-md-8 col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            <form action="<?php echo e(getAdminPanelUrl()); ?>/supports/departments/<?php echo e(!empty($department) ? $department->id.'/update' : 'store'); ?>"
                                  method="Post">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/examsexplorer/public_html/resources/views/admin/supports/department_create.blade.php ENDPATH**/ ?>