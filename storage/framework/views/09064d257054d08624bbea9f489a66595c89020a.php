                                ...
                                <table class="table table-striped font-14">
                                    ...
                                    <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="">
                                                    <span class="d-block font-16 font-weight-500"><?php echo e($order->installment->title); ?></span>
                                                    <span class="d-block font-12 mt-1"><?php echo e(trans('update.target_types_'.$order->installment->target_type)); ?></span>
                                                </div>
                                            </td>
                                            ...
                                            <td class="text-center">
                                                <?php if(!empty($order->installment->upfront)): ?>
                                                    <?php echo e(($order->installment->upfront_type == 'percent') ? $order->installment->upfront.'%' : handlePrice($order->installment->upfront)); ?>
                                            ...
                                            <td class="text-center"><?php echo e($order->installment->steps_count); ?></td>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/examsexplorer/public_html/resources/views/admin/financial/installments/purchases/index.blade.php ENDPATH**/ ?>