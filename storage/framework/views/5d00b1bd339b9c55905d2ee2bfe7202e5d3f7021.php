...
<?php $__env->stopPush(); ?>
<?php echo e(session()->put('my_test_key',url()->current())); ?>
...
<?php $__env->startSection('content'); ?>
            ...
            <div class="col-12 col-lg-8">
                <div class="course-content-body user-select-none">
                    <div class="course-body-on-cover text-white">
                        <?php if(url()->current()!='https://lms.asttrolok.com/course/Free-Astrology-Course'): ?>
                    ...
                    <div class="mt-35">
                        <ul class="nav nav-tabs bg-secondary rounded-sm p-15 d-flex align-items-center justify-content-between" id="tabs-tab" role="tablist">
                            <li class="nav-item">
                                <a class="position-relative font-14 text-white <?php echo e((request()->get('tab','') == 'information') ? 'active' : ''); ?>" id="information-tab"
                            ...
                            <li class="nav-item">
                                <a class="position-relative font-14 text-white <?php echo e((empty(request()->get('tab','')) or request()->get('tab','') == 'content') ? 'active' : ''); ?>" id="content-tab" data-toggle="tab"
                        ...
                        <div class="tab-content" id="nav-tabContent">
                            <div class="tab-pane fade <?php echo e(( request()->get('tab','') == 'information') ? 'show active' : ''); ?> " id="information" role="tabpanel"
                            ...
                            <div class="tab-pane fade <?php echo e((empty(request()->get('tab','')) or request()->get('tab','') == 'content') ? 'show active' : ''); ?>" id="content" role="tabpanel" aria-labelledby="content-tab">
    ...
    <figure>
        <div class="image-box">
           <span class="badge badge-primary">Course</span>
            ...
            <a href="https://lms.asttrolok.com/course/<?php echo e($astromani_23->slug); ?>">
                <img src="<?php echo e($astromani_23->thumbnail); ?>" class="img-cover" alt="<?php echo e($astromani_23->slug); ?>">
            </a>
        ...
        <figcaption class="webinar-card-body">
            <div class="user-inline-avatar d-flex align-items-center">
                <div class="avatar bg-gray200">
                    <img src="<?php echo e($astromani_23->teacher->avatar); ?>" class="img-cover" alt="<?php echo e($astromani_23->full_name); ?>">
                </div>
                <a href="<?php echo e($astromani_23->teacher->getProfileUrl()); ?>" target="_blank" class="user-name ml-5 font-14"><?php echo e($astromani_23->teacher->full_name); ?></a>
            </div>

            <a href="https://lms.asttrolok.com/course/<?php echo e($astromani_23->slug); ?>">
                <h3 class="mt-15  font-weight-bold font-16 text-dark-blue"><?php echo e(clean($astromani_23->title,'title')); ?></h3>
            </a>
    ...
    <figure>
        <div class="image-box">
           <span class="badge badge-primary">Course</span>
            ...
            <a href="https://lms.asttrolok.com/course/<?php echo e($course_Professional->slug); ?>">
                <img src="<?php echo e($course_Professional->thumbnail); ?>" class="img-cover" alt="<?php echo e($course_Professional->slug); ?>">
            </a>
        ...
        <figcaption class="webinar-card-body">
            <div class="user-inline-avatar d-flex align-items-center">
                <div class="avatar bg-gray200">
                    <img src="<?php echo e($course_Professional->teacher->avatar); ?>" class="img-cover" alt="<?php echo e($course_Professional->full_name); ?>">
                </div>
                <a href="<?php echo e($course_Professional->teacher->getProfileUrl()); ?>" target="_blank" class="user-name ml-5 font-14"><?php echo e($course_Professional->teacher->full_name); ?></a>
            </div>

            <a href="https://lms.asttrolok.com/course/<?php echo e($course_Professional->slug); ?>">
                <h3 class="mt-15  font-weight-bold font-16 text-dark-blue"><?php echo e(clean($course_Professional->title,'title')); ?></h3>
            </a>
    ...
    <?php echo $__env->make('web.default.course.login_modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('web.default.course.buynow_modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php endif; ?>
   ...
   <script src="https://cdnjs.cloudflare.com/ajax/libs/videojs-youtube/3.0.1/Youtube.min.js"></script>
     <script src="/assets/default/vendors/video/1212youtube.min.js"></script>
...
<?php echo $__env->make(getTemplate().'.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lmsasttrolok/public_html/resources/views/web/default/course/index.blade.php ENDPATH**/ ?>