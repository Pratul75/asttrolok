...
<?php if($courseTeacher->full_name!='Mr.Alok Khandelwal'): ?>
        <?php if($hasMeeting): ?>
        ...
        <?php endif; ?>
        <?php else: ?>
        <a href="https://alokastrology.com/in-services/" class="btn btn-sm btn-primary teacher-btn-action ml-15"><?php echo e(trans('public.book_a_meeting')); ?></a>
        <?php endif; ?>
    </div>
</div>
<?php /**PATH /home/lmsasttrolok/public_html/resources/views/web/default/course/sidebar_instructor_profile.blade.php ENDPATH**/ ?>