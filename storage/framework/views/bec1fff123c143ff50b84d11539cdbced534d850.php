        ...
        <div class="d-flex align-items-center" href="#collapseFiles<?php echo e($file->id); ?>" aria-controls="collapseFiles<?php echo e($file->id); ?>" data-parent="#<?php echo e($accordionParent); ?>" role="button" data-toggle="collapse" aria-expanded="true">
            ...
            <span class="d-flex align-items-center justify-content-center mr-15">
                <span class="chapter-icon chapter-content-icon">
                    <?php if($file->getIconByType() == 'film'): ?>
...
<div class="">
                    ...
                    <?php elseif($file->accessibility == 'paid'): ?>
                        ...
                        <!--                    Buy now!-->
                        <!--                </button>-->
                            <button type="button"  data-toggle="modal" data-target="#buynow_modal" class="course-content-btns btn btn-sm btn-gray disabled <?php echo e(((empty($user)) ? 'not-login-toast' : (!$hasBought ? 'not-access-toast' : ''))); ?>" >
                                <?php if($file->downloadable): ?>
                                    <?php echo e(trans('home.download')); ?>
                    ...
                    <?php else: ?>
                        ...
                        <?php else: ?>
                            ...
                            <?php if(!empty($authUser)): ?>
                              ...
                              <button type="button" data-id="<?php echo e($file->id); ?>" data-title="<?php echo e($file->title); ?>" class="js-play-video 1 course-content-btns btn btn-sm btn-primary">
                                    <?php echo e(trans('public.play')); ?>
...
<!--        $('.buy_now').click();-->
<!--    }-->
<!--</script>--><?php /**PATH /home/lmsasttrolok/public_html/resources/views/web/default/course/tabs/contents/files.blade.php ENDPATH**/ ?>