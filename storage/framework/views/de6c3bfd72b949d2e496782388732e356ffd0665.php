<div class="row align-items-center input-group mt-2">
    <div class="col-4">
        <div class="form-group ">
            ...
            <input type="text" name="steps[<?php echo e(!empty($step) ? $step->id : 'record'); ?>][title]" value="<?php echo e((!empty($step) and !empty($step->translate($selectedLocale))) ? $step->translate($selectedLocale)->title : ''); ?>" class="form-control"/>
        </div>
    </div>
    ...
    <div class="col-3">
        <div class="form-group ">
            ...
            <input type="number" name="steps[<?php echo e(!empty($step) ? $step->id : 'record'); ?>][deadline]" value="<?php echo e(!empty($step) ? $step->deadline : ''); ?>" class="form-control"/>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-6">
                <div class="form-group ">
                    ...
                    <input type="number" name="steps[<?php echo e(!empty($step) ? $step->id : 'record'); ?>][amount]" value="<?php echo e(!empty($step) ? $step->amount : ''); ?>" class="form-control"/>
                </div>
            </div>
...
<?php /**PATH /home/examsexplorer/public_html/resources/views/admin/financial/installments/create/includes/installment_step_inputs.blade.php ENDPATH**/ ?>