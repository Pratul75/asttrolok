        ...
        <form action="/panel/financial/<?php echo e(!empty($editOfflinePayment) ? 'offline-payments/'. $editOfflinePayment->id .'/update' : 'charge'); ?>" method="post" enctype="multipart/form-data" class="mt-25">
            ...
            <div class="row">
                <?php $__currentLoopData = $paymentChannels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $paymentChannel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if(!empty($paymentChannel->currencies) and in_array($userCurrency, $paymentChannel->currencies)): ?>
...
<?php echo $__env->make(getTemplate() .'.panel.layouts.panel_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/examsexplorer/public_html/resources/views/web/default/panel/financial/account.blade.php ENDPATH**/ ?>