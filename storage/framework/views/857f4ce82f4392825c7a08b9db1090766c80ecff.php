                                ...
                                <div class="webinar-card-body w-100 d-flex flex-column">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between flex-wrap mt-auto">
                                        ...
                                        <div class="d-flex align-items-start flex-column mt-20 mr-15">
                                            ...
                                            <span class="stat-value"><?php echo e(!empty($order->installment->upfront) ? handlePrice($order->installment->getUpfront($itemPrice)) : '-'); ?></span>
                                        </div>

                                        <div class="d-flex align-items-start flex-column mt-20 mr-15">
                                            <span class="stat-title"><?php echo e(trans('update.total_installments')); ?>:</span>
                                            <span class="stat-value"><?php echo e(trans('update.total_parts_count', ['count' => $order->installment->steps_count])); ?> (<?php echo e(handlePrice($order->installment->totalPayments($itemPrice, false))); ?>)</span>
                                        </div>
...
<?php echo $__env->make(getTemplate() .'.panel.layouts.panel_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/examsexplorer/public_html/resources/views/web/default/panel/financial/installments/lists.blade.php ENDPATH**/ ?>