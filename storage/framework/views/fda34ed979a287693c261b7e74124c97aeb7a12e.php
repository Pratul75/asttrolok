...
<?php $__env->startSection('content'); ?>
    ...
    <div class="col-12 col-lg-4 mt-25 mt-lg-0">
        <div class="rounded-lg sidebar-ads mt-15">
            <a href="/instructors">
            <img src="https://lms.asttrolok.com//store/1/default_images/banners/reserve_a_meeting.png" class="img-cover rounded-lg" alt="Reserve a meeting - Course page">
            </a>
         </div>
         <div class="teacher-swiper-container position-relative d-flex justify-content-center mt-0">
            <div class="swiper-container teacher-swiper-container pb-25">
               <div class="swiper-wrapper py-0">
                  <div class="swiper-slide">
                     <div class="rounded-lg shadow-sm mt-15 py-20 pt-20 course-teacher-card d-flex align-items-center flex-column">
                        <div class="teacher-avatar mt-5">
                           <img src="https://lms.asttrolok.com/store/1015/avatar/63b906731e61d.png" class="img-cover" alt="Mr.Alok Khandelwal">
                        ...
                        <h3 class="mt-10 font-16 font-weight-bold text-secondary text-center swiper-container1-title">Mr.Alok Khandelwal</h3>
                        <span class="mt-5 font-14 font-weight-500 text-gray text-center swiper-container1-desc">Founder &amp; World Renowned Astrologer</span>
                        <div class="stars-card d-flex align-items-center  mt-15">
                           <svg xmlns="http://www.w3.org/2000/svg" width="13.663" height="13.663" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-star active">
                           ...
                           <svg xmlns="http://www.w3.org/2000/svg" width="13.663" height="13.663" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-star">
                              <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon>
                           </svg>
                           
                        </div>
                        <div class="mt-25  align-items-center text-center  w-100">
                           <a href="https://alokastrology.com/in-services/" class="btn btn-sm btn-primary ml-15 swiper-container1-btn">Book a Meeting</a>
                        </div>
                     </div>
                  </div>
                  <div class="swiper-slide">
                     <div class="rounded-lg shadow-sm mt-15 py-20 pt-20 course-teacher-card d-flex align-items-center flex-column">
                        <div class="teacher-avatar mt-5">
                           <img src="https://lms.asttrolok.com/store/1/dr-milan-solanki.jpeg" class="img-cover" alt="Dr. Milan Solanki">
                           <span class="user-circle-badge has-verified d-flex align-items-center justify-content-center">
                              <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check text-white">
                                 <polyline points="20 6 9 17 4 12"></polyline>
                              </svg>
                        ...
                        <h3 class="mt-10 font-16 font-weight-bold text-secondary text-center swiper-container1-title">Dr. Milan Solanki</h3>
                        <span class="mt-5 font-14 font-weight-500 text-gray text-center swiper-container1-desc">Astrology</span>
                        <div class="stars-card d-flex align-items-center  mt-15">
                           <svg xmlns="http://www.w3.org/2000/svg" width="13.663" height="13.663" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-star active">
                              <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon>
                           </svg>
                        ...
                        <div class="mt-25  align-items-center text-center  w-100">
                            <a href="https://alokastrology.com/in-services/" class="btn btn-sm btn-primary swiper-container1-btn">Book a Meeting</a>
                        </div>
                     </div>
                  </div>
                  <div class="swiper-slide">
                    <div class="rounded-lg shadow-sm mt-15 py-20 pt-20 course-teacher-card d-flex align-items-center flex-column">
                       <div class="teacher-avatar mt-5">
                          <img src="https://lms.asttrolok.com/store/1/nsbuddhay.png" class="img-cover" alt="Dr. N H Sahasrabuddhe">
                          <span class="user-circle-badge has-verified d-flex align-items-center justify-content-center">
                             <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check text-white">
                                <polyline points="20 6 9 17 4 12"></polyline>
                             </svg>
                       ...
                       <h3 class="mt-10 font-16 font-weight-bold text-secondary text-center swiper-container1-title">Dr. N H Sahasrabuddhe</h3>
                       <span class="mt-5 font-14 font-weight-500 text-gray text-center swiper-container1-desc">Vastu Expert</span>
                       <div class="stars-card d-flex align-items-center  mt-15">
                          <svg xmlns="http://www.w3.org/2000/svg" width="13.663" height="13.663" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-star active">
                             <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon>
                          </svg>
                 ...
                 <div class="swiper-slide">
                    <div class="rounded-lg shadow-sm mt-15 py-20 pt-20 course-teacher-card d-flex align-items-center flex-column">
                       <div class="teacher-avatar mt-5">
                          <img src="https://lms.asttrolok.com/store/1/learn-user2.jpeg" class="img-cover" alt="Mrs. Riddika Panchal">
                          <span class="user-circle-badge has-verified d-flex align-items-center justify-content-center">
                             <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check text-white">
                                <polyline points="20 6 9 17 4 12"></polyline>
                             </svg>
                       ...
                       <h3 class="mt-10 font-16 font-weight-bold text-secondary text-center swiper-container1-title">Mrs. Riddika Panchal</h3>
                       <span class="mt-5 font-14 font-weight-500 text-gray text-center swiper-container1-desc">Numerology Expert</span>
                       <div class="stars-card d-flex align-items-center  mt-15">
                          <svg xmlns="http://www.w3.org/2000/svg" width="13.663" height="13.663" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-star active">
                             <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon>
                          </svg>
    ...
    <div class="col-12 col-lg-4 mt-25 mt-lg-0">
        <div class="d-flex justify-content-between mt-15">
            <div>
             ...
             <div class="rounded-lg sidebar-ads mt-15">
                <a href="">
                    <img src="images.png" class="shadow-sm mt-40 adds rounded-lg" alt="Reserve a meeting - Course page">
                    </a>
             </div>
...
<?php echo $__env->make(getTemplate().'.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lmsbackupnew\resources\views/web/default/pages/home.blade.php ENDPATH**/ ?>