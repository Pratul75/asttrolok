<div class="webinar-card">
    <figure>
        ...
        <figcaption class="webinar-card-body">
            ...
            <a href="<?php echo e($webinar->getUrl()); ?>">
                <h3 class="mt-5 webinar-title font-weight-bold font-16 text-dark-blue"><?php echo e(clean($webinar->title,'title')); ?></h3>
            </a>

            <?php if(!empty($webinar->category)): ?>
                <span class="d-block font-14 mt-5"><?php echo e(trans('public.in')); ?> <a href="<?php echo e($webinar->category->getUrl()); ?>" target="_blank" class="text-decoration-underline"><?php echo e($webinar->category->title); ?></a></span>
            <?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\lmsbackupnew\resources\views/web/default/includes/webinar/grid-card.blade.php ENDPATH**/ ?>