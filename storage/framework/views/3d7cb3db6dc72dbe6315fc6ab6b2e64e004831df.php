    ...
    <div class="container">
        <div class="row login-container">
            ...
            <div class="col-12 col-md-6">
              ...
              <?php if(session()->has('my_test_key')): ?>
     <input type="hidden" name="rd" value="<?php echo e(session()->get('my_test_key')); ?>">
<?php endif; ?>
...
<?php echo $__env->make(getTemplate().'.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lmsasttrolok/public_html/resources/views/web/default/auth/register.blade.php ENDPATH**/ ?>