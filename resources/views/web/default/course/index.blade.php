...
{{--                             
        ...
        <div class="image-box">
           <span class="badge badge-primary">Course</span>
            ...
            <a href="https://lms.asttrolok.com/course/{{ $astromani_23->slug }}">
                <img src="{{ $astromani_23->thumbnail }}" class="img-cover" alt="{{ $astromani_23->slug }}">
            </a>
        ...
        <figcaption class="webinar-card-body">
            <div class="user-inline-avatar d-flex align-items-center">
                <div class="avatar bg-gray200">
                    <img src="{{ $astromani_23->teacher->avatar }}" class="img-cover" alt="{{ $astromani_23->full_name }}">
                </div>
    ...
    <figure>
        <div class="image-box">
           <span class="badge badge-primary">Course</span>
            ...
            <a href="https://lms.asttrolok.com/course/{{ $course_Professional->slug }}">
                <img src="{{ $course_Professional->thumbnail }}" class="img-cover" alt="{{ $course_Professional->slug }}">
            </a>
        ...
        <figcaption class="webinar-card-body">
            <div class="user-inline-avatar d-flex align-items-center">
                <div class="avatar bg-gray200">
                    <img src="{{ $course_Professional->teacher->avatar }}" class="img-cover" alt="{{ $course_Professional->full_name }}">
                </div>
